...
An orb for running the [WhiteSource Renovate](https://renovatebot.com/) CLI on CircleCI

## Usage

For full usage guidelines, see the [orb registry listing](https://circleci.com/orbs/registry/orb/daniel-shuy/renovate).
